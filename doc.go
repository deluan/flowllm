// package pipelm is a GoLang framework for developing applications that leverage the power of language models.
// It uses composability and chain of responsibility patterns, and offers tools to access LLMs, build prompts,
